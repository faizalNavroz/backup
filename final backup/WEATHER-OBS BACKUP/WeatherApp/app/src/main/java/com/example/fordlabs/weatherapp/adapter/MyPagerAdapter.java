...
import com.example.fordlabs.weatherapp.databinding.ViewpagerItemBinding;
...
public class MyPagerAdapter extends PagerAdapter {
    ...
    public MyPagerAdapter(Context context, String []rank, String [] cityNames) {
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        ViewpagerItemBinding activityMainBinding2 = DataBindingUtil.
                inflate(inflater, R.layout.viewpager_item, container, false); //inflate dynamically with data binding.*/

        activityMainBinding2.textView6.setText("");
        ...
        weatherViewModel.getFinal(cityNames[position]);
...
*/
        ...
        activityMainBinding2.setViewModel(new WeatherViewModel());
